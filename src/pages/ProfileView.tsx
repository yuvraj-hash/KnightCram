      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative px-0 md:px-6 mb-6 pt-0 md:pt-6">
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-b-none md:rounded-b-2xl border-x-0 md:border-x border-b border-white/10 shadow-2xl px-4 md:px-6 pb-6 pt-0 -mt-2">
            {/* Stats */}
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-2 md:gap-4 mt-0 pt-4 border-t border-white/10 pb-2 md:pb-0">
              {[
        ...
        <div className="px-4 md:px-6 space-y-6 pb-20 md:pb-16">
          ...
          {/* Tabs */}
          <div className="flex gap-1 bg-white/5 backdrop-blur-xl rounded-xl border border-white/10 p-1 overflow-x-auto scrollbar-hide">
