...
const BottomNav = () => {
    ...
    return (
        <nav
            className="fixed bottom-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-xl border-t border-border/50 h-14 md:h-16 flex md:hidden items-center justify-around px-2 pb-1 transition-all duration-300"
            role="navigation"
